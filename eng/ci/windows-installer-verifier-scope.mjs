const ALLOWED_PACKAGING_BASENAMES = new Set([
  ...
  "windows-shortcut-inspection.mjs",
  "windows-installer-update-lifecycle.mjs",
  "windows-installer-lifecycle-contract.mjs",
  "windows-installer-identity.mjs",
  "windows-installer-profile-authority.test.mjs",
  "windows-real-user-failure-diagnostics.mjs",
  "windows-real-user-failure-diagnostics.test.mjs",
  "windows-installer-lifecycle-report.mjs",
