...
export * from "./protocol-context-contract.js";
import type { ProtocolContext } from "./protocol-context-contract.js";
...
>> = {
  ...
  "enterprise.team.list": "app",
  "enterprise.knowledge.sync": "app",
  "enterprise.knowledge.index": "app",
