...
export const EVENT_CONTEXT_REQUIREMENTS = {
  ...
  "provider.configuration.changed": { session: false, operation: false, requiredScope: "app" },
  "provider.projectConfiguration.changed": { session: false, operation: false, requiredScope: "workspace" },
  ...
  "approval.requested": { session: true, operation: false },
  "approval.resolved": { session: true, operation: false },
  "approval.cancelled": { session: true, operation: false },
  "task.toolMode.changed": { session: true, operation: false },
  "subagent.changed": { session: true, operation: false },
