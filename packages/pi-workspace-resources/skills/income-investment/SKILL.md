...
description: "AI Berkshire skill: Income Investment: Durable and Opportunistic Distribution Analysis. Upstream workflow: income-investment."
...
3. Apply `financial-data` Skill: verify decision-critical financial data with at least two independent sources when available and flag discrepancies above 1%.
