---
name: financial-data
description: "AI Berkshire skill: 财务数据获取与交叉验证规范. Upstream workflow: financial-data."
...
5. 增发/回购后市值验算以最新总股本为准（`scripts/financial_rigor.py verify-market-cap` 偏差>5% 会提示核对）。
