...
This is a shared Pi/Codex hand-written skill kept under `codex-skills/` for simple installation. Do not add a same-named `investment-memo-craft` Skill source unless intentionally adopting this workflow for Claude Code too.
...
- `scripts/report_audit.py` before treating a report as publishable.
