export const zhCNMessages = {
  ...
  commandPalette: {
    ...
    hostUnavailable: "Agent Host 尚未连接，应用设置仍可使用。",
    ...
    hostNotConnected: "Agent Host 尚未连接",
  ...
  credentials: {
    ...
    privacyTitle: "显示认证状态，不读取或回显完整密钥。",
    privacyDetail: "新增的 API 密钥仅保存在 Agent Host 内存中；退出应用或 Agent Host 重启后即清除。",
    providerList: "Pi Provider 列表",
    modelCount: (count: number) => `${count} 个模型`,
    configured: "已配置",
    unconfigured: "未配置",
    empty: "请先选择工作区并等待 Pi Provider 列表加载。",
    enabling: "正在启用…",
    ...
    notConfigured: "尚未配置",
    replaceKeyLabel: "新增密钥以替换本次运行凭据",
    addKeyLabel: "新增本次运行 API 密钥",
    apiKeyLabel: "Provider API 密钥",
    keyPlaceholder: "输入后仅发送到 Agent Host",
    keyPrivacyHelp: "至少 8 个字符。输入值不会进入会话快照、诊断或日志，也不会在关闭后回填。",
    temporaryOrPiConfiguration: "可在此新增临时密钥，或通过 Pi 配置认证。",
  ...
  operation: {
    ...
    running: "Pi 正在执行任务",
    quiet: "任务暂时没有新活动",
    quietDetail: "Agent Host 仍在响应，可以继续等待或停止任务",
    stalled: "Agent Host 心跳延迟",
    stalledDetail: "正在确认任务仍由当前 Host 执行",
    recovering: "正在恢复任务状态",
    recoveringDetail: "正在从 Agent Host 重新同步权威状态",
